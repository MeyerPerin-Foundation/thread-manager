...
from social_media.document import SocialMediaDocument
import matplotlib
matplotlib.use("Agg")
...
class FredContent:
    ...
    def egg_prices(self) -> SocialMediaDocument:
        ...
        d = SocialMediaDocument(text=caption, img_file=file_name, hashtags=[])
        return d

    def gas_prices(self) -> SocialMediaDocument:
        file_name, max_index, max_value = self.generate_time_series_plot(
